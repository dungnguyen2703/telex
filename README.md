...
- Bật/tắt bộ gõ bằng **Ctrl + Space** ở bất kỳ đâu.
...
- **Bật/tắt**: nhấn `Ctrl + Space` để bật hoặc tắt bộ gõ. Khi tắt, chương trình
...
- Không có tùy chọn đổi phím tắt — cố định `Ctrl + Space`.
